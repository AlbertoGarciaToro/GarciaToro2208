public class MaquinaCafe {
    ...
    public boolean recursosNecesarios(int Agu, int Caf, int Cre) {
        return (this.agua >= Agu && this.cafe >= Caf && this.crema >= Cre && this.vasos > 0);
    }

    public void americano() {
        if (recursosNecesarios(180, 15, 0)) {
            this.agua -= 180;
            this.cafe -= 15;
            this.vasos--;
    ...
    public void expreso() {
        if (recursosNecesarios(120, 20, 0)) {
            this.agua -= 120;
            this.cafe -= 20;
            this.vasos--;
    ...
    public void capuchino() {
        if (recursosNecesarios(100, 14, 70)) {
            this.agua -= 100;
            this.cafe -= 14;
            this.crema -= 70;
            this.vasos--;
