...
public class Ventana extends JFrame {
    ...
    public Ventana(String title, JLabel lblId) throws HeadlessException {
        super(title);
        this.lblId = lblId;
        ...
        panel1.setBackground(new Color(194, 248, 172, 255));
        ...
        panel2.setBackground(new Color(229, 193, 193));
        info=new ArrayList<>();
