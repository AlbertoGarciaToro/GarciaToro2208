...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(133, 100, 117));
        lblId=new JLabel("id");
        ...
        panel2.setBackground(new Color(188, 218, 223));
        tblLibro=new JTable();
        ...
        panel3.setBackground(new Color(92, 92, 233));

        //panel 4
        panel4=new JPanel(new FlowLayout());
        panel4.setBackground(new Color(102, 237, 178));
